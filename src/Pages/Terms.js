...
import "./Pages_styles/Terms.css";

const Terms = () => {
  return (
    <div className="terms_div">
      These terms and conditions outline the rules and regulations for the use
      of the Websites. By accessing this website we assume you accept these
      terms and conditions. Do not continue to use the website if you do not
      ...
      Conditions Generator and the Free Terms & Conditions Generator. The
      ...
      interchangeable and therefore as referring to same. Cookies We employ the
      use of cookies. By accessing this website , you agreed to use cookies in
      agreement with the website's Privacy Policy. Most interactive websites use
      cookies to let us retrieve the user’s details for each visit. Cookies are
      used by our website to enable the functionality of certain areas to make
      it easier for people visiting our website. Some of our
      affiliate/advertising partners may also use cookies. License Unless
      otherwise stated, the website and/or its licensors own the intellectual
      ...
      You must not: Republish material from the website Sell, rent or
      sub-license material from the website Reproduce, duplicate or copy
      material from the website Redistribute content from the website This
      ...
      certain areas of the website. the website do not filter, edit, publish or
      review Comments prior to their presence on the website. Comments do not
      reflect the views and opinions of the website, its agents and/or
      ...
      laws, the website shall not be liable for the Comments or for any
      ...
      website. the website reserves the right to monitor all Comments and to
      remove any Comments which can be considered inappropriate, offensive or
      causes breach of these Terms and Conditions. You warrant and represent
      that: You are entitled to post the Comments on our website and have all
      ...
      which is an invasion of privacy Comments will not be used to solicit or
      promote business or custom or present commercial activities or unlawful
      activity. You hereby grant the website a non-exclusive license to use,
      ...
      our home page, to publications or to other Website information so long as
      ...
      and/or services; and (c) fits within the context of the linking party’s
      site. We may consider and approve other link requests from the following
      ...
      visibility of the hyperlink compensates the absence of the website, and
      ...
      our website, you must inform us by sending an e-mail to the website.
      ...
      like to link. Wait 2-3 weeks for a response. Approved organizations mays
      hyperlink to our Website as follows: By use of our corporate name; or By
      use of the uniform resource locator being linked to; or By use of any
      other description of our Website being linked to that makes sense within
      the context and format of content on the linking party’s site. No use of
      the website's logo or other artwork will be allowed for linking absent a
      ...
      Liability We shall not be held responsible for any content that appears on
      your Website. You agree to protect and defend us against all claims that
      are rising on your Website. No link(s) should appear on any Website that
      ...
      amend these terms and conditions and it’s linking policy at any time. By
